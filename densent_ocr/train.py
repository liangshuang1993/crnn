...
tensorboard = TensorBoard(r'../keras_ocr_model/tflog-densent2',write_graph=True)
...
model.load_weights(r'../keras_ocr_model.bak/weights7-densent-10.hdf5', by_name=True)
