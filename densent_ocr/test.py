...
#IMAGE_DIR = '/datasets/text_renderer/val6/default'
...
#with open('/datasets/text_renderer/val6/default/tmp_labels.txt', 'r') as f:
...
modelPath =r'../keras_ocr_model/weights1-densent-05.hdf5'
...
for i, line in enumerate(lines):
    ...
    # testimage = r'/home/ls/project201803/tensorflow.image/opt/text_detection/ocr2/test.JPG'
